 ...
 */
public class OuterTextGrowingCircle extends View {
    ...
    public OuterTextGrowingCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public OuterTextGrowingCircle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        this.setTitleMargin(a.getDimension(R.styleable.GrowingSlider_circle_titleMargin, 12));
        this.setResultMargin(a.getDimension(R.styleable.GrowingSlider_circle_resultMargin, 12));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        float maxMargin = (titleMargin > resultMargin) ? titleMargin : resultMargin;
        float maxTextSize = (titleSize > resultSize) ? titleSize : resultSize;
        float total = maxMargin + maxTextSize + thickness / 2;
        this.circleBox = new RectF(total, total, w - total, h - total);
        this.widthCanvas = w;
        this.heightCanvas = h;
    }
    ...
    public void setAnimationDuration(int millis) {
        drawAnimator.setDuration(millis);
    }
    ...
    public void setResultMargin(float margin) {
        this.resultMargin = margin;
    }
    ...
    private void drawText(Canvas c) {
        ...
        c.drawText(titleText, widthCanvas / 2, titleSize, TitlePaint);
        c.drawText(textValue, widthCanvas / 2, heightCanvas, ValuePaint);
    }
